...
*   [Getting started with PAPI @ LaCASA lab](http://lacasa.uah.edu/index.php/tools-tutorials/getting-started-with-papi)  
*   [PERF tool](http://lacasa.uah.edu/index.php/tools-tutorials/perf-tool)   


### Simulators  
*   [Multi2Sim](http://lacasa.uah.edu/index.php/tools-tutorials/multi2sim)  
*   [Gem5](http://lacasa.uah.edu/index.php/tools-tutorials/gem5)    
*   [SimpleScalar tool set](http://lacasa.uah.edu/index.php/tools-tutorials/simplescalar-tool-set)  
